...
//     const handleEnrollNow = (data: CourseData) => {
...
//     const [isOpenFiles, setIsOpenFiles] = useState(Array(webinar?.files_chapters.length).fill(false));
//     const toggleFiles = (index: number) => {
//       const newIsOpenDropdowns = [...isOpenFiles];
//       newIsOpenDropdowns[index] = !newIsOpenDropdowns[index];
//       setIsOpenFiles(newIsOpenDropdowns);
//     };
//     const [isOpenSessions, setIsOpenSessions] = useState(Array(webinar?.session_chapters.length).fill(false));
...
//   const initialFilesStates = Array(webinar?.files_chapters.length).fill(false);
//   const [isOpenParts, setIsOpenParts] = useState(initialFilesStates);

//   const initialSessionsStates = Array(webinar?.session_chapters.length).fill(false);
...
//                       isOpen={isOpenFiles[index]}
//                       setIsOpen={() => toggleFiles(index)}
//                     />
//                 )}
//             </View>
//           }
